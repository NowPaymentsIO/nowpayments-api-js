declare const _default: {
    ...
    getMinimumPaymentStatus: ({ apiKey, currency_from, currency_to }: import("./get-minimum-payment-status").GetMinimumPaymentStatus) => Promise<import("../types").Error | import("./get-minimum-payment-status").GetMinimumPaymentStatusReturn>;
