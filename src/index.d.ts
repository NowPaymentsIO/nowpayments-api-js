import { ICreatePayment, IGetEstimatePrice, IGetPaymentStatus, IGetMinimumPaymentStatus, IGetListPayments, ICreateInvoice } from './types';
declare class NOWPaymentsApi {
    ...
    getMinimumPaymentStatus({ currency_from, currency_to }: IGetMinimumPaymentStatus): Promise<import("./types").Error | import("./actions/get-minimum-payment-status").GetMinimumPaymentStatusReturn>;
